...
export function formatNumeral(value: string, options?: FormatNumeralOptions): string {
  const {
...
export function unformatNumeral(value: string, options?: Pick<FormatNumeralOptions, 'numeralDecimalMark'>): string {
