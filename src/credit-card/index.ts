...
export function formatCreditCard(value: string, options?: FormatCreditCardOptions): string {
  const {
...
export function getCreditCardType(value: string, delimiter?: DelimiterType): CreditCardType {
  // strip non-numeric characters
  value = stripNonNumeric(value)
  // strip delimiters
  value = stripDelimiters({
