...
export function handleMultiDatesSelect(date: Date, modelValue: WritableComputedRef<InternalModuleValue>, multiDatesLimit?: number | string | null): void {
...
export function setPresetDate(opts: {
...
export function getRangeWithFixedDate(date: Date, modelValue: WritableComputedRef<InternalModuleValue>, emit: VueEmit, defaultedRange: ComputedRef<RangeConfig>): Date[] {
  if (
