...
export const inputSlots: SlotInput[] = [
  { name: 'trigger' },
  { name: 'input-icon' },
  { name: 'clear-icon' },
  { name: 'dp-input' },
...
export function mapSlots(slots: Slots, usage: 'all' | 'monthYear' | 'timePicker' | 'input' | 'action' | 'calendar' | 'menu' | 'shared' | 'yearMode', presetDates?: PresetDate[]): string[] {
