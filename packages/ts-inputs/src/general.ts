...
export function formatGeneral(value: string, options: FormatGeneralOptions): string {
  const {
    blocks,
    delimiter = '',
    delimiters = [],
...
export function unformatGeneral(value: string, options: Pick<FormatGeneralOptions, 'delimiter' | 'delimiters'>): string {
